...
def main(args):
    ...
    for e in range(episodes):
        ...
        if e == 0 or e % 5 == 0:
            ...
            # train the models for correcting the cl- and cd trajectories, only the last episode since policy mismatch
            # increases too much and the models wouldn't be able to make accurate corrections
            ...
            corr_model_cd, corr_model_cl = train_correction_models(corr_out[0], corr_out[1], training_path, buffer_size,
                                                                   len_traj, min_max)
        ...
        # fill buffer with trajectories generated by the environment models, start correcting models for e > 20 since
        # in the 1st episodes models are in general quite inaccurate (despite corrections)
        else:
            if e > 20:
                corr = True
            else:
