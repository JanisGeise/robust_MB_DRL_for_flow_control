...
def main(args):
    ...
    for e in range(episodes):
        ...
        if e == 0 or e % 5 == 0:
            ...
            # train the models for correcting the cl- and cd trajectories, if specified only the last episode since
            # policy mismatch increases too much and the models wouldn't be able to make accurate corrections
            if corr_traj:
